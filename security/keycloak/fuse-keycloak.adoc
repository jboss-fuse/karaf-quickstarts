...
----
$ pwd
/data/servers/keycloak-4.8.3.Final

$ bin/add-user-keycloak.sh -u admin
Press ctrl-d (Unix) or ctrl-z (Windows) to exit
Password:
Added 'admin' to '/data/servers/keycloak-4.8.3.Final/standalone/configuration/keycloak-add-user.json', restart server to load user
----
...
[listing,options="nowrap"]
----
2018-06-26 18:06:01,880 INFO  {fileinstall-/data/servers/fuse-karaf-${version.org.jboss.fuse-karaf}/etc} (PaxLoggingServiceImpl.java:398) : Creating configuration from org.ops4j.pax.web.context-cxf.cfg
