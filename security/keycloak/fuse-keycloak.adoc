...
----
$ pwd
/data/servers/rh-sso-7.4.6

$ bin/add-user-keycloak.sh -u admin
Press ctrl-d (Unix) or ctrl-z (Windows) to exit
Password: passw0rd
Added 'admin' to '/data/servers/rh-sso-7.4.6/standalone/configuration/keycloak-add-user.json', restart server to load user
----
...
Keycloak/RH-SSO instance, we can't log into `master` realm and click `Import`, We have to click
...
* `org.keycloak.adapters.jaas.BearerTokenLoginModule` (_sufficient_) with
 `keycloak-config-file=${karaf.base}/etc/keycloak-hawtio.json` by default. This module is used if we already have OAuth2
...
karaf@root()> config:property-set --pid org.apache.karaf.management rmiRegistryHost 0.0.0.0
karaf@root()> config:property-set --pid org.apache.karaf.management rmiServerHost 0.0.0.0
----
...
────┼──────────┼─────┼───────────────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
234 │ Active   │  80 │ 7.3.8                     │ OPS4J Pax Web - Undertow, Fragments: 253
...
253 │ Resolved │  80 │ ${version.org.keycloak}               │ Keycloak Fuse 7.0 Adapter - Undertow, Hosts: 234
----
...
There is https://github.com/apache/camel/blob/camel-2.23.2/components/camel-undertow/src/main/docs/undertow-component.adoc[Camel undertow component] which exposes an HTTP-based endpoint using
...
* `Authorization` header contains HTTP Basic credentials of the _client_ (not _user_ which is _resource owner_), which is
...
[listing,options="nowrap"]
----
2021-04-01 08:56:25,628 INFO  {fileinstall-/data/servers/fuse-karaf-7.10.0.fuse-7_10_0046/etc} [org.apache.felix.fileinstall.internal.Util$OsgiLogger.log()] (Util.java:205) : Creating configuration from org.ops4j.pax.web.context-cxf.cfg
2021-04-01 08:56:25,632 INFO  {CM Configuration Updater (Update: pid=org.ops4j.pax.web.context.770248d8-6ccb-4cd5-93da-436ed81e1fa6)} [org.ops4j.pax.web.service.internal.HttpContextProcessing.updated()] (HttpContextProcessing.java:88) : Updated configuration for pid=org.ops4j.pax.web.context.770248d8-6ccb-4cd5-93da-436ed81e1fa6
2021-04-01 08:56:25,638 WARN  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.reconfigure()] (HttpContextProcessing.java:192) : Incorrect org.ops4j.pax.web.context.770248d8-6ccb-4cd5-93da-436ed81e1fa6 configuration - missing bundle.symbolicName selector
2021-04-01 08:56:30,635 INFO  {fileinstall-/data/servers/fuse-karaf-7.10.0.fuse-7_10_0046/etc} [org.apache.felix.fileinstall.internal.Util$OsgiLogger.log()] (Util.java:205) : Updating configuration from org.ops4j.pax.web.context-cxf.cfg
2021-04-01 08:56:30,638 INFO  {CM Configuration Updater (Update: pid=org.ops4j.pax.web.context.770248d8-6ccb-4cd5-93da-436ed81e1fa6)} [org.ops4j.pax.web.service.internal.HttpContextProcessing.updated()] (HttpContextProcessing.java:88) : Updated configuration for pid=org.ops4j.pax.web.context.770248d8-6ccb-4cd5-93da-436ed81e1fa6
2021-04-01 08:56:30,640 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.addingBundle()] (HttpContextProcessing.java:366) : Found bundle "org.apache.cxf.cxf-rt-transports-http", scheduling customization of its WebContainer
2021-04-01 08:56:30,642 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:216) : Customizing WebContainer for bundle org.apache.cxf.cxf-rt-transports-http/3.3.6.fuse-790029
2021-04-01 08:56:30,644 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:233) : Setting context parameters in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": {keycloak.config.resolver=org.keycloak.adapters.osgi.HierarchicalPathBasedKeycloakConfigResolver}
2021-04-01 08:56:30,645 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.undertow.internal.Context.stop()] (Context.java:176) : Stopping context /
2021-04-01 08:56:30,645 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.undertow.internal.Context.destroy()] (Context.java:232) : destroying context DefaultHttpContext [bundle=org.apache.cxf.cxf-rt-transports-http [115], contextID=default], with context path:
2021-04-01 08:56:30,658 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:239) : Registering login configuration in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": method=KEYCLOAK, realm=edcd6f04-0740-4479-82dc-762f71b87a3b
2021-04-01 08:56:30,662 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:251) : Registering security mappings in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": SecurityConstraintsMapping{name='cxf', url='/cxf/*', roles=[admin, superuser]}
2021-04-01 08:56:30,663 INFO  {paxweb-context-4-thread-1} [org.ops4j.pax.web.service.undertow.internal.Context.start()] (Context.java:165) : Starting context /
----
. Install the example:
+
[listing,options="nowrap"]
