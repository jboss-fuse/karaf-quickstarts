...
----
$ pwd
/data/servers/rh-sso-7.3.5

$ bin/add-user-keycloak.sh -u admin
Press ctrl-d (Unix) or ctrl-z (Windows) to exit
Password:
Added 'admin' to '/data/servers/rh-sso-7.3.5/standalone/configuration/keycloak-add-user.json', restart server to load user
----
...
────┼──────────┼─────┼───────────────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
220 │ Active   │  80 │ 7.3.0                     │ OPS4J Pax Web - Undertow, Fragments: 234
...
...
[listing,options="nowrap"]
----
2020-01-16 09:46:02,371 INFO  {fileinstall-/data/servers/fuse-karaf-7.6.0.fuse-760014/etc} [org.apache.felix.fileinstall.internal.Util$OsgiLogger.log()] (Util.java:205) : Creating configuration from org.ops4j.pax.web.context-cxf.cfg
2020-01-16 09:46:10,383 INFO  {CM Configuration Updater (Update: pid=org.ops4j.pax.web.context.7a930319-1180-4298-af2a-e2dad296dcca)} [org.ops4j.pax.web.service.internal.HttpContextProcessing.updated()] (HttpContextProcessing.java:88) : Updated configuration for pid=org.ops4j.pax.web.context.7a930319-1180-4298-af2a-e2dad296dcca
2020-01-16 09:46:10,384 INFO  {paxweb-context-3-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.addingBundle()] (HttpContextProcessing.java:366) : Found bundle "org.apache.cxf.cxf-rt-transports-http", scheduling customization of its WebContainer
2020-01-16 09:46:10,384 INFO  {paxweb-context-3-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:216) : Customizing WebContainer for bundle org.apache.cxf.cxf-rt-transports-http/3.2.7.fuse-760017
2020-01-16 09:46:10,385 INFO  {paxweb-context-3-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:233) : Setting context parameters in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": {keycloak.config.resolver=org.keycloak.adapters.osgi.HierarchicalPathBasedKeycloakConfigResolver}
2020-01-16 09:46:10,385 INFO  {paxweb-context-3-thread-1} [org.ops4j.pax.web.service.undertow.internal.Context.stop()] (Context.java:176) : Stopping context /
2020-01-16 09:46:10,386 INFO  {paxweb-context-3-thread-1} [org.ops4j.pax.web.service.undertow.internal.Context.destroy()] (Context.java:232) : destroying context DefaultHttpContext [bundle=org.apache.cxf.cxf-rt-transports-http [109], contextID=default], with context path:
2020-01-16 09:46:10,391 INFO  {paxweb-context-3-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:239) : Registering login configuration in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": method=KEYCLOAK, realm=6419636e-9437-4388-8606-b5ce3a082710
2020-01-16 09:46:10,392 INFO  {paxweb-context-3-thread-1} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:251) : Registering security mappings in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": SecurityConstraintsMapping{name='cxf', url='/cxf/*', roles=[admin, superuser]}
----
. Install the example:
+
[listing,options="nowrap"]
