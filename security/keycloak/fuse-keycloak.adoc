...
----
$ pwd
/data/servers/rh-sso-7.6.0

$ bin/add-user-keycloak.sh -u admin
Press ctrl-d (Unix) or ctrl-z (Windows) to exit
Password: passw0rd
Added 'admin' to '/data/servers/rh-sso-7.6.0/standalone/configuration/keycloak-add-user.json', restart server to load user
----
...
be used. If it points to the same _client_ in keycloak server, we only have to switch realm for JMX Access:
...
[listing,options="nowrap"]
----
2022-09-21 11:57:53,549 INFO  {fileinstall-/data/servers/fuse-karaf-7.11.1.fuse-7_11_1-00005/etc} [org.apache.felix.fileinstall.internal.Util$OsgiLogger.log()] (Util.java:205) : Updating configuration {org.ops4j.pax.web.context~cxf} from /data/servers/fuse-karaf-7.11.1.fuse-7_11_1-00005/etc/org.ops4j.pax.web.context-cxf.cfg
2022-09-21 11:57:53,550 INFO  {CM Configuration Updater (Update: pid=org.ops4j.pax.web.context~cxf)} [org.ops4j.pax.web.service.internal.HttpContextProcessing.updated()] (HttpContextProcessing.java:88) : Updated configuration for pid=org.ops4j.pax.web.context~cxf
2022-09-21 11:57:53,551 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.addingBundle()] (HttpContextProcessing.java:366) : Found bundle "org.apache.cxf.cxf-rt-transports-http", scheduling customization of its WebContainer
2022-09-21 11:57:53,551 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:216) : Customizing WebContainer for bundle org.apache.cxf.cxf-rt-transports-http/3.3.6.fuse-7_11_1-00004
2022-09-21 11:57:53,552 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:233) : Setting context parameters in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": {keycloak.config.resolver=org.keycloak.adapters.osgi.HierarchicalPathBasedKeycloakConfigResolver}
2022-09-21 11:57:53,552 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.undertow.internal.Context.stop()] (Context.java:176) : Stopping context /
2022-09-21 11:57:53,552 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.undertow.internal.Context.destroy()] (Context.java:232) : destroying context DefaultHttpContext [bundle=org.apache.cxf.cxf-rt-transports-http [116], contextID=default], with context path:
2022-09-21 11:57:53,556 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:239) : Registering login configuration in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": method=KEYCLOAK, realm=4c1af59b-6815-4282-b854-7991e9c06d45
2022-09-21 11:57:53,557 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.internal.HttpContextProcessing$HttpContextTracker.processContext()] (HttpContextProcessing.java:251) : Registering security mappings in WebContainer for bundle "org.apache.cxf.cxf-rt-transports-http": SecurityConstraintsMapping{name='cxf', url='/cxf/*', roles=[admin, superuser]}
2022-09-21 11:57:53,558 INFO  {paxweb-context-4-thread-2} [org.ops4j.pax.web.service.undertow.internal.Context.start()] (Context.java:165) : Starting context /
----
. Install the example:
+
[listing,options="nowrap"]
