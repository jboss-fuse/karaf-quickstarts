...
`org.ops4j.pax.jdbc.impl.DriverDataSourceFactory` provided by `mvn:org.ops4j.pax.jdbc/pax-jdbc/1.5.3` bundle. All it
...
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc/1.5.3
Bundle ID: 241
...
PostgreSQL JDBC Driver (242) provides:
--------------------------------------
...
karaf@root()> install -s mvn:mysql/mysql-connector-java/8.0.28
Bundle ID: 243

karaf@root()> bundle:services -p 243

Oracle Corporation's JDBC and XDevAPI Driver for MySQL (243) provides:
----------------------------------------------------------------------
objectClass = [org.osgi.service.jdbc.DataSourceFactory]
osgi.jdbc.driver.class = com.mysql.cj.jdbc.Driver
osgi.jdbc.driver.name = com.mysql.cj-native
osgi.jdbc.driver.version = 8.0.28
...
-----------------------------------------
 ...
 service.scope = singleton
Provided by :
 Oracle Corporation's JDBC and XDevAPI Driver for MySQL (243)
----
...
NOTE: `mvn:org.postgresql/postgresql/42.3.3` bundle correctly implements OSGi JDBC specification and registers
...
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-mysql/1.5.3`
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-mariadb/1.5.3`
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-db2/1.5.3`
* ...
...
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-mysql/1.5.3
Bundle ID: 244

karaf@root()> bundle:services -p 244

OPS4J Pax JDBC MySQL Driver Adapter (244) provides:
---------------------------------------------------
objectClass = [org.osgi.service.jdbc.DataSourceFactory]
...
-----------------------------------------
 ...
 service.scope = singleton
Provided by :
 OPS4J Pax JDBC MySQL Driver Adapter (244)
----
...
`mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.3` bundle provides a Managed Service Factory
...
[listing,options="nowrap"]
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.3
Bundle ID: 245
karaf@root()> bundle:services -p 245

OPS4J Pax JDBC Config (245) provides:
-------------------------------------
...
----------------------------------------------------------------
Pid:            org.ops4j.datasource.5470f5eb-e120-4c10-9954-c842f08954b3
...
Properties:
   ...
   service.pid = org.ops4j.datasource.5470f5eb-e120-4c10-9954-c842f08954b3
...
Adding features: jdbc/[4.2.15.fuse-7_11_0-00011,4.2.15.fuse-7_11_0-00011]
...
karaf@root()> jdbc:ds-list
Name    │ Service Id │ Product │ Version │ URL                                  │ Status
────────┼────────────┼─────────┼─────────┼──────────────────────────────────────┼───────
mysqlds │ 249        │ MySQL   │ 8.0.28  │ jdbc:mysql://localhost:3306/reportdb │ OK
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.datasource)'
----------------------------------------------------------------
Pid:            org.ops4j.datasource.74fd6565-37af-4497-9402-00b1ce08d46b
FactoryPid:     org.ops4j.datasource
BundleLocation: ?
Properties:
   dataSourceName = mysqlds
   ...
   osgi.jdbc.driver.name = mysql
   service.factoryPid = org.ops4j.datasource
   service.pid = org.ops4j.datasource.74fd6565-37af-4497-9402-00b1ce08d46b
...
Name                │ Class                    │ Version │ Registration bundle
────────────────────┼──────────────────────────┼─────────┼────────────────────
com.mysql.cj-native │ com.mysql.cj.jdbc.Driver │ 8.0.28  │ com.mysql.cj [244]
----

.Install MySQL-specific DataSourceFactory service
[listing,options="nowrap"]
----
karaf@root()> feature:repo-add mvn:org.ops4j.pax.jdbc/pax-jdbc-features/1.5.3/xml/features-gpl
Adding feature url mvn:org.ops4j.pax.jdbc/pax-jdbc-features/1.5.3/xml/features-gpl
karaf@root()> feature:install pax-jdbc-mysql
karaf@root()> jdbc:ds-factories
Name                │ Class                    │ Version │ Registration bundle
────────────────────┼──────────────────────────┼─────────┼───────────────────────────────
com.mysql.cj-native │ com.mysql.cj.jdbc.Driver │ 8.0.28  │ com.mysql.cj [244]
mysql               │ com.mysql.jdbc.Driver    │         │ org.ops4j.pax.jdbc.mysql [245]
----
...
Name    │ Service Id │ Product │ Version │ URL                                               │ Status
────────┼────────────┼─────────┼─────────┼───────────────────────────────────────────────────┼───────
mysqlds │ 251        │ MySQL   │ 8.0.28  │ jdbc:mysql://localhost:3306/reportdb?useSSL=false │ OK
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.datasource)'
----------------------------------------------------------------
Pid:            org.ops4j.datasource.8f58c4dd-7586-4270-b99a-1aaa58525745
FactoryPid:     org.ops4j.datasource
BundleLocation: mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.3
Properties:
   dataSourceName = mysqlds
   dataSourceType = DataSource
   osgi.jdbc.driver.name = mysql
   password = fuse
   service.factoryPid = org.ops4j.datasource
   service.pid = org.ops4j.datasource.8f58c4dd-7586-4270-b99a-1aaa58525745
...
[listing, options="nowrap"]
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-pool-dbcp2/1.5.3
Bundle ID: 246

karaf@root()> bundle:services -p 246

OPS4J Pax JDBC Pooling DBCP2 (246) provides:
--------------------------------------------
...
-----------------------------------------
 ...
 service.scope = singleton
Provided by :
 Oracle Corporation's JDBC and XDevAPI Driver for MySQL (244)
...
-----------------------------------------
 ...
 service.scope = singleton
Provided by :
 OPS4J Pax JDBC MySQL Driver Adapter (245)
Used by:
...
--------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JDBC Pooling Narayana (223)
...
--------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JDBC Pooling DBCP2 (246)
...
----------------------
 ...
 service.factoryPid = org.ops4j.datasource
 service.id = 254
 service.pid = org.ops4j.datasource.74759908-70bf-4c9b-9854-c1e4c67cdcbb
 service.scope = singleton
Provided by :
 OPS4J Pax JDBC Config (242)
----
...
Bundle ID: 84
karaf@root()> install -s mvn:org.apache.commons/commons-dbcp2/2.9.0
Bundle ID: 83
...
Name            │ Service Id │ Product    │ Version                        │ URL                                           │ Status
────────────────┼────────────┼────────────┼────────────────────────────────┼───────────────────────────────────────────────┼────────
jdbc/postgresql │ 245        │ PostgreSQL │ 14.2 (Debian 14.2-1.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
...
Name            │ Service Id │ Product    │ Version                        │ URL                                           │ Status
────────────────┼────────────┼────────────┼────────────────────────────────┼───────────────────────────────────────────────┼───────
jdbc/postgresql │ 253        │ PostgreSQL │ 14.2 (Debian 14.2-1.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
...
Name            │ Service Id │ Product    │ Version                        │ URL                                           │ Status
────────────────┼────────────┼────────────┼────────────────────────────────┼───────────────────────────────────────────────┼───────
jdbc/postgresql │ 251        │ PostgreSQL │ 14.2 (Debian 14.2-1.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
jdbc/postgresql │ 252        │ PostgreSQL │ 14.2 (Debian 14.2-1.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
