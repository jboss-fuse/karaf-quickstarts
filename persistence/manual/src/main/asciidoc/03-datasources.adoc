...
`org.ops4j.pax.jdbc.impl.DriverDataSourceFactory` provided by `mvn:org.ops4j.pax.jdbc/pax-jdbc/1.5.0` bundle. All it
...
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc/1.5.0
Bundle ID: 240
...
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-mysql/1.5.0`
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-mariadb/1.5.0`
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-db2/1.5.0`
* ...
...
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-mysql/1.5.0
Bundle ID: 243
...
`mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.0` bundle provides a Managed Service Factory
...
[listing,options="nowrap"]
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.0
Bundle ID: 244
...
----------------------------------------------------------------
Pid:            org.ops4j.datasource.de7eadf9-9119-4b90-9f80-e9091607b190
...
Properties:
   ...
   service.pid = org.ops4j.datasource.de7eadf9-9119-4b90-9f80-e9091607b190
...
Adding features: jdbc/[4.2.11.fuse-790004,4.2.11.fuse-790004]
...
karaf@root()> jdbc:ds-list
Name    │ Service Id │ Product │ Version │ URL                                  │ Status
────────┼────────────┼─────────┼─────────┼──────────────────────────────────────┼───────
mysqlds │ 255        │ MySQL   │ 8.0.23  │ jdbc:mysql://localhost:3306/reportdb │ OK
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.datasource)'
----------------------------------------------------------------
Pid:            org.ops4j.datasource.03e4e78b-f717-429c-8b7d-dd2e2d622f5e
FactoryPid:     org.ops4j.datasource
BundleLocation: ?
Properties:
   dataSourceName = mysqlds
   ...
   osgi.jdbc.driver.name = mysql
   service.factoryPid = org.ops4j.datasource
   service.pid = org.ops4j.datasource.03e4e78b-f717-429c-8b7d-dd2e2d622f5e
...
Name                │ Class                    │ Version │ Registration bundle
────────────────────┼──────────────────────────┼─────────┼────────────────────
com.mysql.cj-native │ com.mysql.cj.jdbc.Driver │ 8.0.20  │ com.mysql.cj [243]
----

.Install MySQL-specific DataSourceFactory service
[listing,options="nowrap"]
----
karaf@root()> feature:repo-add mvn:org.ops4j.pax.jdbc/pax-jdbc-features/1.5.0/xml/features-gpl
Adding feature url mvn:org.ops4j.pax.jdbc/pax-jdbc-features/1.5.0/xml/features-gpl
...
Name    │ Service Id │ Product │ Version │ URL                                               │ Status
────────┼────────────┼─────────┼─────────┼───────────────────────────────────────────────────┼───────
mysqlds │ 252        │ MySQL   │ 8.0.23  │ jdbc:mysql://localhost:3306/reportdb?useSSL=false │ OK
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.datasource)'
----------------------------------------------------------------
Pid:            org.ops4j.datasource.d2068008-2318-43ae-91d2-ab133f8ce37b
FactoryPid:     org.ops4j.datasource
...
Properties:
   ...
   password = fuse
   service.factoryPid = org.ops4j.datasource
   service.pid = org.ops4j.datasource.d2068008-2318-43ae-91d2-ab133f8ce37b
...
[listing, options="nowrap"]
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-pool-dbcp2/1.5.0
Bundle ID: 245
...
----------------------
 ...
 service.factoryPid = org.ops4j.datasource
 service.id = 255
 service.pid = org.ops4j.datasource.681c1c39-de38-4fa3-968b-03301fab60f0
 service.scope = singleton
Provided by :
 OPS4J Pax JDBC Config (241)
----
...
Name            │ Service Id │ Product    │ Version                        │ URL                                           │ Status
────────────────┼────────────┼────────────┼────────────────────────────────┼───────────────────────────────────────────────┼───────
jdbc/postgresql │ 247        │ PostgreSQL │ 13.2 (Debian 13.2-1.pgdg100+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
...
Name            │ Service Id │ Product    │ Version                        │ URL                                          │ Status
────────────────┼────────────┼────────────┼────────────────────────────────┼──────────────────────────────────────────────┼───────
jdbc/postgresql │ 253        │ PostgreSQL │ 13.2 (Debian 13.2-1.pgdg100+1) │ jdbc:postgresql://localhost:5432/reportdb?.. │ OK
jdbc/postgresql │ 254        │ PostgreSQL │ 13.2 (Debian 13.2-1.pgdg100+1) │ jdbc:postgresql://localhost:5432/reportdb?.. │ OK
