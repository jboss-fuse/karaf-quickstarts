...
`org.ops4j.pax.jdbc.impl.DriverDataSourceFactory` provided by `mvn:org.ops4j.pax.jdbc/pax-jdbc/1.5.1` bundle. All it
...
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc/1.5.1
Bundle ID: 240

karaf@root()> install -s mvn:org.postgresql/postgresql/42.2.19
Bundle ID: 241

karaf@root()> bundle:services -p 241

PostgreSQL JDBC Driver (241) provides:
--------------------------------------
objectClass = [org.osgi.service.jdbc.DataSourceFactory]
osgi.jdbc.driver.class = org.postgresql.Driver
osgi.jdbc.driver.name = PostgreSQL JDBC Driver
osgi.jdbc.driver.version = 42.2.19
service.bundleid = 241
service.id = 246
service.scope = singleton

karaf@root()> install -s mvn:mysql/mysql-connector-java/8.0.26
Bundle ID: 242

karaf@root()> bundle:services -p 242

Oracle Corporation's JDBC and XDevAPI Driver for MySQL (242) provides:
----------------------------------------------------------------------
objectClass = [org.osgi.service.jdbc.DataSourceFactory]
osgi.jdbc.driver.class = com.mysql.cj.jdbc.Driver
osgi.jdbc.driver.name = com.mysql.cj-native
osgi.jdbc.driver.version = 8.0.26
...
-----------------------------------------
 ...
 service.scope = singleton
Provided by :
 Oracle Corporation's JDBC and XDevAPI Driver for MySQL (242)
----
...
NOTE: `mvn:org.postgresql/postgresql/42.2.19` bundle correctly implements OSGi JDBC specification and registers
...
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-mysql/1.5.1`
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-mariadb/1.5.1`
* `mvn:org.ops4j.pax.jdbc/pax-jdbc-db2/1.5.1`
* ...
...
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-mysql/1.5.1
Bundle ID: 243
...
OPS4J Pax JDBC MySQL Driver Adapter (243) provides:
---------------------------------------------------
objectClass = [org.osgi.service.jdbc.DataSourceFactory]
...
-----------------------------------------
 ...
 service.scope = singleton
Provided by :
 OPS4J Pax JDBC MySQL Driver Adapter (243)
----
...
`mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.1` bundle provides a Managed Service Factory
...
[listing,options="nowrap"]
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.1
Bundle ID: 244
...
----------------------------------------------------------------
Pid:            org.ops4j.datasource.9ae12d94-21fe-4d9e-b0e4-e93d12d5ba4b
...
Properties:
   ...
   service.pid = org.ops4j.datasource.9ae12d94-21fe-4d9e-b0e4-e93d12d5ba4b
...
Adding features: jdbc/[4.2.12.fuse-7_10_0-00002,4.2.12.fuse-7_10_0-00002]
...
karaf@root()> jdbc:ds-list
Name    │ Service Id │ Product │ Version │ URL                                  │ Status
────────┼────────────┼─────────┼─────────┼──────────────────────────────────────┼───────
mysqlds │ 251        │ MySQL   │ 8.0.26  │ jdbc:mysql://localhost:3306/reportdb │ OK
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.datasource)'
----------------------------------------------------------------
Pid:            org.ops4j.datasource.c3d8a247-bcf8-4b74-9c1a-60f0a23c8da6
FactoryPid:     org.ops4j.datasource
BundleLocation: ?
Properties:
   dataSourceName = mysqlds
   ...
   osgi.jdbc.driver.name = mysql
   service.factoryPid = org.ops4j.datasource
   service.pid = org.ops4j.datasource.c3d8a247-bcf8-4b74-9c1a-60f0a23c8da6
...
Name                │ Class                    │ Version │ Registration bundle
────────────────────┼──────────────────────────┼─────────┼────────────────────
com.mysql.cj-native │ com.mysql.cj.jdbc.Driver │ 8.0.26  │ com.mysql.cj [243]
----

.Install MySQL-specific DataSourceFactory service
[listing,options="nowrap"]
----
karaf@root()> feature:repo-add mvn:org.ops4j.pax.jdbc/pax-jdbc-features/1.5.1/xml/features-gpl
Adding feature url mvn:org.ops4j.pax.jdbc/pax-jdbc-features/1.5.1/xml/features-gpl
karaf@root()> feature:install pax-jdbc-mysql
karaf@root()> jdbc:ds-factories
Name                │ Class                    │ Version │ Registration bundle
────────────────────┼──────────────────────────┼─────────┼───────────────────────────────
com.mysql.cj-native │ com.mysql.cj.jdbc.Driver │ 8.0.26  │ com.mysql.cj [243]
mysql               │ com.mysql.jdbc.Driver    │         │ org.ops4j.pax.jdbc.mysql [244]
----
...
Name    │ Service Id │ Product │ Version │ URL                                               │ Status
────────┼────────────┼─────────┼─────────┼───────────────────────────────────────────────────┼───────
mysqlds │ 252        │ MySQL   │ 8.0.26  │ jdbc:mysql://localhost:3306/reportdb?useSSL=false │ OK
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.datasource)'
----------------------------------------------------------------
Pid:            org.ops4j.datasource.adb8ac6e-dc08-4b22-8772-ce9ab1aa1f76
FactoryPid:     org.ops4j.datasource
BundleLocation: mvn:org.ops4j.pax.jdbc/pax-jdbc-config/1.5.1
Properties:
   dataSourceName = mysqlds
   dataSourceType = DataSource
   osgi.jdbc.driver.name = mysql
   password = fuse
   service.factoryPid = org.ops4j.datasource
   service.pid = org.ops4j.datasource.adb8ac6e-dc08-4b22-8772-ce9ab1aa1f76
...
[listing, options="nowrap"]
----
karaf@root()> install -s mvn:org.ops4j.pax.jdbc/pax-jdbc-pool-dbcp2/1.5.1
Bundle ID: 245

karaf@root()> bundle:services -p 245

OPS4J Pax JDBC Pooling DBCP2 (245) provides:
--------------------------------------------
...
--------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JDBC Pooling DBCP2 (245)
...
----------------------
 ...
 service.factoryPid = org.ops4j.datasource
 service.id = 255
 service.pid = org.ops4j.datasource.6c52af90-6439-4ae3-9a68-bfe919ac97e5
 service.scope = singleton
Provided by :
 OPS4J Pax JDBC Config (241)
----
...
Bundle ID:241
karaf@root()> install -s mvn:org.apache.commons/commons-dbcp2/2.8.0
Bundle ID: 83
...
Name            │ Service Id │ Product    │ Version                        │ URL                                           │ Status
────────────────┼────────────┼────────────┼────────────────────────────────┼────────────────────────────────────────────────────────
jdbc/postgresql │ 342        │ PostgreSQL │ 13.4 (Debian 13.4-4.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
...
<!--
    ...
    mvn:org.postgresql/postgresql/42.2.19 bundle natively
-->
...
Name            │ Service Id │ Product    │ Version                        │ URL                                           │ Status
────────────────┼────────────┼────────────┼────────────────────────────────┼───────────────────────────────────────────────┼───────
jdbc/postgresql │ 253        │ PostgreSQL │ 13.4 (Debian 13.4-4.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
...
────────────────┼────────────┼────────────┼────────────────────────────────┼───────────────────────────────────────────────┼───────
jdbc/postgresql │ 253        │ PostgreSQL │ 13.4 (Debian 13.4-4.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
jdbc/postgresql │ 254        │ PostgreSQL │ 13.4 (Debian 13.4-4.pgdg110+1) │ jdbc:postgresql://localhost:5432/reportdb?... │ OK
