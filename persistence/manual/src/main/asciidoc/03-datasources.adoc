...
osgi.jdbc.driver.version = 42.2.14
...
NOTE: `mvn:org.postgresql/postgresql/42.2.14` bundle correctly implements OSGi JDBC specification and registers
...
<!--
    ...
    mvn:org.postgresql/postgresql/42.2.14 bundle natively
-->
