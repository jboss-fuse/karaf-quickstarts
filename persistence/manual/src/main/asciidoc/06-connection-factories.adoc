...
* `mvn:org.ops4j.pax.jms/pax-jms-activemq/1.1.1`
* `mvn:org.ops4j.pax.jms/pax-jms-artemis/1.1.1`
* `mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.1`
...
OPS4J Pax JMS Config (242) provides:
------------------------------------
objectClass = [org.ops4j.pax.jms.config.ConfigLoader]
...
OPS4J Pax JMS Artemis Support (269) provides:
-----
...
`mvn:org.ops4j.pax.jms/pax-jms-config/1.1.1` bundle provides a Managed Service Factory
...
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.35c7ad20-4f09-4bcd-bfad-d0f6558c4c2b
...
Properties:
   ...
   service.pid = org.ops4j.connectionfactory.35c7ad20-4f09-4bcd-bfad-d0f6558c4c2b
   type = artemis
----
+
...
Adding features: jms/[4.2.15.fuse-7_11_0-00011,4.2.15.fuse-7_11_0-00011]
...
...
────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼────────────────────────────┼────────────┼──────────┼─────────────┼─────────┼─────────────────────────────
ID:e4b0ecdd-a389-11ec-93d9-083a885f3339 │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ ActiveMQQueue[DEV.QUEUE.1] │ Never      │ 4        │ false       │         │ Mon Mar 14 12:28:38 CET 2022
----
...
Properties:
   connectionFactoryType = ConnectionFactory
   felix.fileinstall.filename = file:/data/servers/fuse-karaf-7.11.0.fuse-7_11_0-00013/etc/org.ops4j.connectionfactory-artemis.cfg
   jms.consumerMaxRate = 1234
   jms.password = fuse
   jms.url = tcp://localhost:61616
   jms.user = fuse
...
karaf@root()> config:edit org.ops4j.connectionfactory.35c7ad20-4f09-4bcd-bfad-d0f6558c4c2b
...
As mentioned in <<ibm-mq,chapter about IBM MQ>>, we can download drivers from https://developer.ibm.com/articles/mq-downloads/#java[IBM MQ page].
`OSGi` directory of `9.2.5.0-IBM-MQ-Install-Java-All.jar` package contains only two bundles:

* `com.ibm.mq.osgi.allclient_9.2.5.0.jar` - actual driver
* `com.ibm.mq.osgi.allclientprereqs_9.2.5.0.jar` - preprequisites

While the prerequisites JAR contain required `fscontext.jar`, `org.json.jar` and `providerutil.jar` libraries, it also contains:

* `bcprov-jdk15on.jar`, `bcutil-jdk15on.jar` and `bcpkix-jdk15on.jar`, while {f7} ships those (in newer version) in `$FUSE_HOME/lib/ext`
...
Unfortunately, `com.ibm.mq.osgi.allclient_9.2.5.0.jar` bundle contains this manifest header:
[listing,options="nowrap"]
----
Require-Bundle =
...
[listing,options="nowrap"]
----
karaf@root()> install 'file:///data/downloads/ibm.com/IBM%20MQ/9.2.5.0-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.2.5.0.jar'
Bundle ID: 241
karaf@root()> feature:install pax-jms-ibmmq
karaf@root()> la -l | grep allclient
241 │ Resolved │  80 │ 9.2.5.0                     │ file:///data/downloads/ibm.com/IBM%20MQ/9.2.5.0-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.2.5.0.jar
karaf@root()> start 241
karaf@root()> feature:install pax-jms-config
karaf@root()> la -l
...
────┼──────────┼─────┼─────────────────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
243 │ Active   │  80 │ 1.1.1                       │ mvn:org.ops4j.pax.jms/pax-jms-api/1.1.1
244 │ Active   │  80 │ 1.1.1                       │ mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.1
245 │ Active   │  80 │ 1.1.1                       │ mvn:org.ops4j.pax.jms/pax-jms-config/1.1.1
...
karaf@root()> la -l | grep ibm
241 │ Active   │  80 │ 9.2.5.0                     │ file:///data/downloads/ibm.com/IBM%20MQ/9.2.5.0-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.2.5.0.jar
242 │ Active   │  35 │ 7.11.0.fuse-7_11_0-00013    │ mvn:org.jboss.fuse.modules/fuse-pax-jms-ibmmq-compatibility/7.11.0.fuse-7_11_0-00013
244 │ Active   │  80 │ 1.1.1                       │ mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.1
----

IMPORTANT: When installing `com.ibm.mq.osgi.allclient_9.2.5.0.jar` bundle first, we can't start it, because it requires the _prerequisites_ bundle provided by `pax-jms-ibmmq` feature. Only after feature installation, we can start `com.ibm.mq.osgi.allclient_9.1.0.7.jar` bundle. It can't stay at `RESOLVED` state, because only after start it provides necessary services.
...
<features name="xa-connection-factories-clients" xmlns="http://karaf.apache.org/xmlns/features/v1.5.0">
    <feature name="ibmmq9-jms-client">
        ...
        <bundle>file:///path/to/com.ibm.mq.osgi.allclient_9.2.5.0.jar</bundle>
    </feature>
</features>
----
...
OPS4J Pax JMS IBM MQ Support (244) provides:
--------------------------------------------
objectClass = [org.ops4j.pax.jms.service.ConnectionFactoryFactory]
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.connectionfactory)'
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.87b28daf-7e0e-4f7f-9fc5-893649d66fe5
FactoryPid:     org.ops4j.connectionfactory
BundleLocation: ?
Properties:
   connectionFactoryType = ConnectionFactory
   ...
   service.factoryPid = org.ops4j.connectionfactory
   service.pid = org.ops4j.connectionfactory.87b28daf-7e0e-4f7f-9fc5-893649d66fe5
   type = ibmmq
----
...
Message ID                                          │ Content                     │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination          │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────────────────┼─────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼──────────────────────┼────────────┼──────────┼─────────────┼─────────┼─────────────────────────────
ID:414d512046555345514d202020202020b6142f6202cd0040 │ Hello IBM MQ 9 from PAX-JMS │ UTF-8   │      │                │ Persistent    │ queue:///DEV.QUEUE.1 │ Never      │ 4        │ false       │         │ Mon Mar 14 13:38:58 CET 2022
----
...
----------------------------------------------------
 ...
 type = artemis
Provided by :
 OPS4J Pax JMS Artemis Support (271)
----
...
Message ID                              │ Content                    │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination                │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼────────────────────────────┼────────────┼──────────┼─────────────┼─────────┼─────────────────────────────
ID:e42347ce-a393-11ec-b77c-083a885f3339 │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ ActiveMQQueue[DEV.QUEUE.1] │ Never      │ 4        │ false       │         │ Mon Mar 14 13:40:12 CET 2022


karaf@root()> config:list '(service.factoryPid=org.ops4j.connectionfactory)'
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.82aa2811-2a16-4806-a333-bfd3587c661d
FactoryPid:     org.ops4j.connectionfactory
BundleLocation: mvn:org.ops4j.pax.jms/pax-jms-config/1.1.1
Properties:
   name = artemis
   osgi.jndi.service.name = jms/artemis
   password = fuse
   service.factoryPid = org.ops4j.connectionfactory
   service.pid = org.ops4j.connectionfactory.82aa2811-2a16-4806-a333-bfd3587c661d
   type = artemis
...
OPS4J Pax JMS MessagingHub JMS Pool implementation (243) provides:
------------------------------------------------------------------
objectClass = [org.ops4j.pax.jms.service.PooledConnectionFactoryFactory]
pool = pooledjms
service.bundleid = 243
service.id = 244
service.scope = singleton
xa = false
-----
...
Adding features: pax-jms-pool-pooledjms/[1.1.1,1.1.1],pax-jms-artemis/[1.1.1,1.1.1]
...
----
...
----------------------------------------------------
 ...
 type = artemis
Provided by :
 OPS4J Pax JMS Artemis Support (270)
...
----------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JMS MessagingHub JMS Pool implementation (243)
...
----------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JMS Pax TRANSX JMS pool (274)
...
-----------------------------
 ...
 protocol = amqp
 service.bundleid = 273
 service.factoryPid = org.ops4j.connectionfactory
 service.id = 387
 service.pid = org.ops4j.connectionfactory.3dc3df75-ad2f-4821-8554-fb981636f31f
 service.scope = singleton
 type = artemis
Provided by :
 OPS4J Pax JMS Config (273)
----
...
Message ID                                      │ Content                    │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼─────────────┼────────────┼──────────┼─────────────┼─────────┼─────────────────────────────
ID:f9b9752b-3c90-4a8d-ace2-e29d65be1dda:2:1:1-1 │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ DEV.QUEUE.1 │ Never      │ 4        │ false       │         │ Mon Mar 14 13:43:31 CET 2022
----
...
karaf@root()> install -s mvn:org.apache.commons/commons-pool2/2.11.1
Bundle ID: 84
karaf@root()> install -s mvn:org.messaginghub/pooled-jms/1.2.1.redhat-00011
Bundle ID: 265
karaf@root()> install -s blueprint:file://$PQ_HOME/message-brokers/blueprints/artemis-manual.xml
Bundle ID: 266

karaf@root()> bundle:services -p 266
...
Bundle ID: 278
karaf@root()> bundle:services -p 278
...
karaf@root()> bundle:services -p 279
...
* has `pax.jms.service.id.ref = 315` property, so we know what's the original connection factory service that's wrapped
