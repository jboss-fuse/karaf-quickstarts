...
* `mvn:org.ops4j.pax.jms/pax-jms-activemq/1.1.0`
* `mvn:org.ops4j.pax.jms/pax-jms-artemis/1.1.0`
* `mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.0`
...
OPS4J Pax JMS Config (247) provides:
------------------------------------
...
`mvn:org.ops4j.pax.jms/pax-jms-config/1.1.0` bundle provides a Managed Service Factory
...
OPS4J Pax JMS Config (241) provides:
------------------------------------
objectClass = [org.osgi.service.cm.ManagedServiceFactory]
service.bundleid = 247
service.id = 257
...
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.83bc079f-61d3-40af-8df5-975ba3d2f1bb
...
Properties:
   ...
   service.pid = org.ops4j.connectionfactory.83bc079f-61d3-40af-8df5-975ba3d2f1bb
   type = artemis
----
+
...
Adding features: jms/[4.2.12.fuse-7_10_0-00002,4.2.12.fuse-7_10_0-00002]
...
...
────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼────────────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:515e48d7-251f-11ec-b6f1-083a885f3339 │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ ActiveMQQueue[DEV.QUEUE.1] │ Never      │ 4        │ false       │         │ Mon Oct 04 16:28:17 CEST 2021
----
...
karaf@root()> config:edit org.ops4j.connectionfactory.83bc079f-61d3-40af-8df5-975ba3d2f1bb
...
`OSGi` directory of `9.1.0.7-IBM-MQ-Install-Java-All.jar` package contains only two bundles:

* `com.ibm.mq.osgi.allclient_9.1.0.7.jar` - actual driver
* `com.ibm.mq.osgi.allclientprereqs_9.1.0.7.jar` - preprequisites
...
Unfortunately, `com.ibm.mq.osgi.allclient_9.1.0.7.jar` bundle contains this manifest header:
[listing,options="nowrap"]
----
Require-Bundle =
...
[listing,options="nowrap"]
----
karaf@root()> install 'file:///data/downloads/ibm.com/IBM%20MQ/9.1.0.7-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.1.0.7.jar'
Bundle ID: 279
karaf@root()> feature:install pax-jms-ibmmq
araf@root()> la -l | grep allclient
279 │ Resolved │  80 │ 9.1.0.7                            │ file:///data/downloads/ibm.com/IBM%20MQ/9.1.0.7-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.1.0.7.jar
karaf@root()> start 279
karaf@root()> feature:install pax-jms-config
karaf@root()> la -l
...
────┼──────────┼─────┼───────────────────────────┼────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
246 │ Active   │  80 │ 1.1.0                     │ mvn:org.ops4j.pax.jms/pax-jms-api/1.1.0
247 │ Active   │  80 │ 1.1.0                     │ mvn:org.ops4j.pax.jms/pax-jms-config/1.1.0
281 │ Active   │  80 │ 1.1.0                     │ mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.0
...
karaf@root()> la -l | grep ibm
279 │ Active   │  80 │ 9.1.0.7                            │ file:///data/downloads/ibm.com/IBM%20MQ/9.1.0.7-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.1.0.7.jar
280 │ Active   │  35 │ 7.10.0.fuse-7_10_0-00002           │ mvn:org.jboss.fuse.modules/fuse-pax-jms-ibmmq-compatibility/7.10.0.fuse-7_10_0-00002
281 │ Active   │  80 │ 1.1.0                              │ mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.0
----

IMPORTANT: When installing `com.ibm.mq.osgi.allclient_9.1.0.7.jar` bundle first, we can't start it, because it requires the _prerequisites_ bundle provided by `pax-jms-ibmmq` feature. Only after feature installation, we can start `com.ibm.mq.osgi.allclient_9.1.0.7.jar` bundle. It can't stay at `RESOLVED` state, because only after start it provides necessary services.
...
<features name="xa-connection-factories-clients" xmlns="http://karaf.apache.org/xmlns/features/v1.5.0">
    <feature name="ibmmq9-jms-client">
        ...
        <bundle>file:///path/to/com.ibm.mq.osgi.allclient_9.1.0.7.jar</bundle>
    </feature>
</features>
----
...
OPS4J Pax JMS IBM MQ Support (281) provides:
--------------------------------------------
objectClass = [org.ops4j.pax.jms.service.ConnectionFactoryFactory]
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.connectionfactory)'
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.2cf36b59-2e9f-49b5-99f7-d0f4d4115189
FactoryPid:     org.ops4j.connectionfactory
BundleLocation: ?
Properties:
   connectionFactoryType = ConnectionFactory
   ...
   service.factoryPid = org.ops4j.connectionfactory
   service.pid = org.ops4j.connectionfactory.2cf36b59-2e9f-49b5-99f7-d0f4d4115189
   type = ibmmq
----
...
Message ID                                          │ Content                     │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination          │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────────────────┼─────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼──────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:414d512046555345514d2020202020208b0c5b6102490040 │ Hello IBM MQ 9 from PAX-JMS │ UTF-8   │      │                │ Persistent    │ queue:///DEV.QUEUE.1 │ Never      │ 4        │ false       │         │ Mon Oct 04 16:33:09 CEST 2021
----
...
Message ID                              │ Content                    │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination                │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼────────────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:b4aa697a-2524-11ec-9f0a-083a885f3339 │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ ActiveMQQueue[DEV.QUEUE.1] │ Never      │ 4        │ false       │         │ Mon Oct 04 17:06:52 CEST 2021


karaf@root()> config:list '(service.factoryPid=org.ops4j.connectionfactory)'
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.f0106953-1da6-4560-9e62-92d3e2cd4780
FactoryPid:     org.ops4j.connectionfactory
BundleLocation: mvn:org.ops4j.pax.jms/pax-jms-config/1.1.0
Properties:
   name = artemis
   osgi.jndi.service.name = jms/artemis
   password = fuse
   service.factoryPid = org.ops4j.connectionfactory
   service.pid = org.ops4j.connectionfactory.f0106953-1da6-4560-9e62-92d3e2cd4780
   type = artemis
...
OPS4J Pax JMS MessagingHub JMS Pool implementation (242) provides:
------------------------------------------------------------------
...
Adding features: pax-jms-pool-pooledjms/[1.1.0,1.1.0],pax-jms-artemis/[1.1.0,1.1.0]
...
----
...
----------------------------------------------------
 ...
 type = artemis
Provided by :
 OPS4J Pax JMS Artemis Support (266)
...
----------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JMS MessagingHub JMS Pool implementation (242)
...
----------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JMS Pax TRANSX JMS pool (270)
...
-----------------------------
 ...
 service.factoryPid = org.ops4j.connectionfactory
 service.id = 319
 service.pid = org.ops4j.connectionfactory.c0b17113-da8f-4605-bf41-50607c491cd0
 service.scope = singleton
 type = artemis
Provided by :
...
Message ID                                      │ Content                    │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼─────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:26e7309e-7ac7-40ee-8f11-42e13607c3b3:2:1:1-1 │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ DEV.QUEUE.1 │ Never      │ 4        │ false       │         │ Mon Oct 04 17:13:56 CEST 2021
----
...
karaf@root()> install -s mvn:org.apache.commons/commons-pool2/2.9.0
Bundle ID: 261
...
Bundle ID: 275
karaf@root()> bundle:services -p 275
...
karaf@root()> bundle:services -p 273
