...
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.4c358352-0c95-48a4-b5df-a5a085224e46
...
Properties:
   ...
   service.pid = org.ops4j.connectionfactory.4c358352-0c95-48a4-b5df-a5a085224e46
   type = artemis
----
+
...
────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼────────────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:5a814c5b-9393-11ea-ab15-54e1ad3055fb │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ ActiveMQQueue[DEV.QUEUE.1] │ Never      │ 4        │ false       │         │ Mon May 11 16:26:07 CEST 2020
----
...
can't use `com.ibm.mq.osgi.allclient_9.1.5.0.jar` bundle.

With IBM MQ 9.0 drivers described in karaf-quickstarts for Fuse 7.6.0 version and earlier, I've presented the method to extract Java OSGi libraries from `mqadv_dev914_linux_x86-64.tar.gz`. However, with version 9.1 there are miscellaneous issues related to OSGi imports and exports and I wasn't able to find proper combination of libraries to use.

When simply installing two bundles:
[listing,options="nowrap"]
----
310 │ Active    │  80 │ 9.1.5.0                   │ file:///data/downloads/ibm.com/IBM%20MQ/9.1.5.0-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclientprereqs_9.1.5.0.jar
311 │ Active    │  80 │ 9.1.5.0                   │ file:///data/downloads/ibm.com/IBM%20MQ/9.1.5.0-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.1.5.0.jar
----

We can get this error:
[listing,options="nowrap"]
----
2020-05-11 17:21:44,951 ERROR {FelixDispatchQueue} [org.apache.felix.framework.EventDispatcher.invokeFrameworkListenerCallback()] (EventDispatcher.java:881) : FrameworkEvent ERROR
org.osgi.framework.BundleException: Uses constraint violation. Unable to resolve resource org.ops4j.pax.jms.pax-jms-ibmmq [org.ops4j.pax.jms.pax-jms-ibmmq [295](R 295.0)] because it is exposed to package 'javax.jms' from resources com.ibm.mq.osgi.allclientprereqs [com.ibm.mq.osgi.allclientprereqs [310](R 310.0)] and javax.jms-api [javax.jms-api [41](R 41.0)] via two dependency chains.

Chain 1:
  org.ops4j.pax.jms.pax-jms-ibmmq [org.ops4j.pax.jms.pax-jms-ibmmq [295](R 295.0)]
    import: (&(osgi.wiring.package=javax.jms)(version>=2.0.0)(!(version>=3.0.0)))
     |
    export: osgi.wiring.package: javax.jms
  com.ibm.mq.osgi.allclientprereqs [com.ibm.mq.osgi.allclientprereqs [310](R 310.0)]

Chain 2:
  org.ops4j.pax.jms.pax-jms-ibmmq [org.ops4j.pax.jms.pax-jms-ibmmq [295](R 295.0)]
    import: (&(osgi.wiring.package=org.ops4j.pax.jms.service)(version>=1.0.0)(!(version>=2.0.0)))
     |
    export: osgi.wiring.package=org.ops4j.pax.jms.service; uses:=javax.jms
  org.ops4j.pax.jms.pax-jms-api [org.ops4j.pax.jms.pax-jms-api [270](R 270.0)]
    import: (&(osgi.wiring.package=javax.jms)(version>=2.0.0)(!(version>=3.0.0)))
     |
    export: osgi.wiring.package: javax.jms
  javax.jms-api [javax.jms-api [41](R 41.0)] Unresolved requirements: [[org.ops4j.pax.jms.pax-jms-ibmmq [295](R 295.0)] osgi.wiring.package; (&(osgi.wiring.package=org.ops4j.pax.jms.service)(version>=1.0.0)(!(version>=2.0.0)))]
...
The problem is that `javax.jms` package is now exported from two different bundles:

* `mvn:javax.jms/javax.jms-api/2.0.1`
* `com.ibm.mq.osgi.allclientprereqs_9.1.5.0.jar`

But instead of trying to find better bundles than `com.ibm.mq.osgi.allclientprereqs_9.1.5.0.jar`, we'll uninstall `mvn:javax.jms/javax.jms-api/2.0.1` instead.

[listing,options="nowrap"]
----
karaf@root()> la -l|grep jms
 41 │ Active    │  20 │ 2.0.1                     │ mvn:javax.jms/javax.jms-api/2.0.1
karaf@root()> uninstall 41

karaf@root()> install 'file:///data/downloads/ibm.com/IBM%20MQ/9.1.5.0-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclientprereqs_9.1.5.0.jar'
Bundle ID: 310
...
Bundle ID: 311
karaf@root()> start 310
karaf@root()> start 311
karaf@root()> refresh
----
+
...
OPS4J Pax JMS IBM MQ Support (295) provides:
--------------------------------------------
objectClass = [org.ops4j.pax.jms.service.ConnectionFactoryFactory]
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.connectionfactory)'
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.48fb6947-686b-4ffe-a65b-0fdc4990521b
FactoryPid:     org.ops4j.connectionfactory
BundleLocation: ?
Properties:
   connectionFactoryType = ConnectionFactory
   ...
   service.factoryPid = org.ops4j.connectionfactory
   service.pid = org.ops4j.connectionfactory.48fb6947-686b-4ffe-a65b-0fdc4990521b
   type = ibmmq
----
...
Message ID                                          │ Content                     │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination          │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────────────────┼─────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼──────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:414d512046555345514d202020202020964ab95e033bdc24 │ Hello IBM MQ 9 from PAX-JMS │ UTF-8   │      │                │ Persistent    │ queue:///DEV.QUEUE.1 │ Never      │ 4        │ false       │         │ Mon May 11 17:33:34 CEST 2020
----
