...
OPS4J Pax JMS Artemis Support (265) provides:
---------------------------------------------
...
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.1368af5e-4cd2-422c-9b55-0aec19994fc9
...
Properties:
   ...
   service.pid = org.ops4j.connectionfactory.1368af5e-4cd2-422c-9b55-0aec19994fc9
   type = artemis
----
+
...
Adding features: jms/[4.2.11.fuse-790004,4.2.11.fuse-790004]
...
...
────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼────────────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:59668d6e-923f-11eb-b52a-54e1ad3055fb │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ ActiveMQQueue[DEV.QUEUE.1] │ Never      │ 4        │ false       │         │ Wed Mar 31 18:37:14 CEST 2021
----
...
karaf@root()> config:edit org.ops4j.connectionfactory.1368af5e-4cd2-422c-9b55-0aec19994fc9
...
273 │ Resolved │  80 │ 9.1.0.7                   │ file:///data/downloads/ibm.com/IBM%20MQ/9.1.0.7-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.1.0.7.jar
karaf@root()> start 273
karaf@root()> feature:install pax-jms-config
karaf@root()> la -l
...
────┼──────────┼─────┼───────────────────────────┼────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
240 │ Active   │  80 │ 1.1.0                     │ mvn:org.ops4j.pax.jms/pax-jms-api/1.1.0
241 │ Active   │  80 │ 1.1.0                     │ mvn:org.ops4j.pax.jms/pax-jms-config/1.1.0
275 │ Active   │  80 │ 1.1.0                     │ mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.0
...
karaf@root()> la -l | grep ibm
273 │ Active   │  80 │ 9.1.0.7                   │ file:///data/downloads/ibm.com/IBM%20MQ/9.1.0.7-IBM-MQ-Install-Java-All/wmq/OSGi/com.ibm.mq.osgi.allclient_9.1.0.7.jar
274 │ Active   │  35 │ 7.10.0.fuse-7_10_0046         │ mvn:org.jboss.fuse.modules/fuse-pax-jms-ibmmq-compatibility/7.10.0.fuse-7_10_0046
275 │ Active   │  80 │ 1.1.0                     │ mvn:org.ops4j.pax.jms/pax-jms-ibmmq/1.1.0
----
...
OPS4J Pax JMS IBM MQ Support (275) provides:
--------------------------------------------
objectClass = [org.ops4j.pax.jms.service.ConnectionFactoryFactory]
...
karaf@root()> config:list '(service.factoryPid=org.ops4j.connectionfactory)'
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.744f07c2-e25b-4a7e-9c66-23052ee02d42
FactoryPid:     org.ops4j.connectionfactory
BundleLocation: ?
Properties:
   connectionFactoryType = ConnectionFactory
   felix.fileinstall.filename = file:/data/servers/fuse-karaf-7.10.0.fuse-7_10_0046/etc/org.ops4j.connectionfactory-ibmmq.cfg
   jms.CCSID = 1208
   ...
   service.factoryPid = org.ops4j.connectionfactory
   service.pid = org.ops4j.connectionfactory.744f07c2-e25b-4a7e-9c66-23052ee02d42
   type = ibmmq
----
...
Message ID                                          │ Content                     │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination          │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────────────────┼─────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼──────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:414d512046555345514d2020202020206ca06460032be121 │ Hello IBM MQ 9 from PAX-JMS │ UTF-8   │      │                │ Persistent    │ queue:///DEV.QUEUE.1 │ Never      │ 4        │ false       │         │ Wed Mar 31 18:45:39 CEST 2021
----
...
Message ID                              │ Content                    │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination                │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼────────────────────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:d961ce73-9240-11eb-bfcd-54e1ad3055fb │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ ActiveMQQueue[DEV.QUEUE.1] │ Never      │ 4        │ false       │         │ Wed Mar 31 18:47:58 CEST 2021

karaf@root()> config:list '(service.factoryPid=org.ops4j.connectionfactory)'
----------------------------------------------------------------
Pid:            org.ops4j.connectionfactory.abea1739-c4cd-4dbe-9bc4-239138901088
FactoryPid:     org.ops4j.connectionfactory
...
Properties:
   ...
   password = fuse
   service.factoryPid = org.ops4j.connectionfactory
   service.pid = org.ops4j.connectionfactory.abea1739-c4cd-4dbe-9bc4-239138901088
   type = artemis
...
OPS4J Pax JMS MessagingHub JMS Pool implementation (269) provides:
------------------------------------------------------------------
...
----------------------------------------------------
 ...
 type = artemis
Provided by :
 OPS4J Pax JMS Artemis Support (265)
...
----------------------------------------------------------
 ...
 xa = false
Provided by :
 OPS4J Pax JMS MessagingHub JMS Pool implementation (266)
...
-----------------------------
 ...
 service.factoryPid = org.ops4j.connectionfactory
 service.id = 319
 service.pid = org.ops4j.connectionfactory.2d7643bd-33f0-4080-80ee-9757664d5a02
 service.scope = singleton
 type = artemis
Provided by :
...
Message ID                                      │ Content                    │ Charset │ Type │ Correlation ID │ Delivery Mode │ Destination │ Expiration │ Priority │ Redelivered │ ReplyTo │ Timestamp
────────────────────────────────────────────────┼────────────────────────────┼─────────┼──────┼────────────────┼───────────────┼─────────────┼────────────┼──────────┼─────────────┼─────────┼──────────────────────────────
ID:ed870f51-f629-4577-9f8d-660846c97af2:2:1:1-1 │ Hello Artemis from PAX-JMS │ UTF-8   │      │                │ Persistent    │ DEV.QUEUE.1 │ Never      │ 4        │ false       │         │ Wed Mar 31 18:51:12 CEST 2021
----
...
Bundle ID: 83
karaf@root()> install -s mvn:org.messaginghub/pooled-jms/1.2.1.redhat-00003
Bundle ID: 272
