...
from `org.jboss.jts.integration` module (`mvn:org.jboss.narayana.jts/narayana-jts-integration/5.11.3.Final-redhat-00001`)
which delegates to `com.arjuna.ats.internal.jta.transaction.arjunacore.TransactionManagerImple`
from `org.jboss.jts` module (`mvn:org.jboss.narayana.jts/narayana-jts-idlj/5.11.3.Final-redhat-00001`).
